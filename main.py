...
# Label mapping
labels = '''Airplane Automobile Bird Cat Deer Dog Frog Horse Ship Truck'''.split() #u can update labels here if that object present in that dataset CIFAR-10
    ...
    def classify_image(self):
        if self.img_array is not None:
            try:
                ...
                # Update result label
                result_text = f"Predicted Label: {predicted_class}\nPredicted Percentage: {predicted_percentage:.2f}%"
